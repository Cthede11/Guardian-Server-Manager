...
Write-Host "🚀 Starting Guardian Desktop Application in Development Mode..." -ForegroundColor Green
...
Write-Host "📦 Starting backend (hostd)..." -ForegroundColor Yellow
...
Write-Host "🎨 Starting frontend (guardian-ui)..." -ForegroundColor Yellow
...
try {
    ...
    Write-Host "❌ Frontend development server failed: $_" -ForegroundColor Red
...
Write-Host "🎉 Guardian Desktop Application development environment started!" -ForegroundColor Green
Write-Host "📱 Frontend: http://localhost:5173" -ForegroundColor Blue
Write-Host "🔧 Backend API: http://localhost:8080" -ForegroundColor Blue
Write-Host "🖥️ Desktop App: Tauri development window" -ForegroundColor Blue
