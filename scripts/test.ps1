...
function Show-Help {
    ...
    Write-Host ""
    Write-Host "Usage: .\scripts\test.ps1 [COMMAND]" -ForegroundColor $Colors.Info
    Write-Host ""
    ...
    Write-Host "  .\scripts\test.ps1 start    # Start the platform" -ForegroundColor $Colors.Info
    Write-Host "  .\scripts\test.ps1 test     # Run all tests" -ForegroundColor $Colors.Info
    Write-Host "  .\scripts\test.ps1 status   # Check if platform is running" -ForegroundColor $Colors.Info
}
